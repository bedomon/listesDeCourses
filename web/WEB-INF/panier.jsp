                        ...
                        <div>
                            <form action="${pageContext.request.contextPath}/panier" id="form${a.id}" method="post">
                                <label class="custom-control custom-checkbox">
                                    ...
                                    <!-- JavaScript nous facilite la vie !! -->
                                    <!-- L'input checkbox a le comportement d'un input submit -->
                                    <input type="checkbox" class="custom-control-input" name="coche"
                                           onclick="document.forms['form${a.id}'].submit();" ${a.coche?"checked":""}/>
...
<footer class="row bg-dark footer-demodule fixed-bottom py-1">
    <div class="text-center col-2 offset-3">
        <a class="btn" href="${pageContext.request.contextPath}/listes" title="Retour Ã  la liste des courses"><i
                class="material-icons">arrow_back</i></a>
    </div>
    <!-- /.container -->
    <div class="text-center col-2 offset-2">
        <a class="btn" href="${pageContext.request.contextPath}/panier?id=${listeCourse.id}&clear" title="clear"><i
